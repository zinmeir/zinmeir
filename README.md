...
<table align="center" width="100%">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>A containerized cyber deception and SIEM platform that emulates vulnerable Linux servers to capture SSH attacks, credentials, keystrokes, and attacker telemetry for real-time threat analysis.</p>
      <img src="https://img.shields.io/badge/Docker-0d1117?style=flat-square&logo=docker&logoColor=2496ED" />
